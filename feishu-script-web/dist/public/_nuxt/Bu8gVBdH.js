import{_ as h}from"./B9No-RpQ.js";import{E as k,a as T}from"./DWEVfuml.js";import{E as g,a as E}from"./DFr4MPH_.js";import{E as V}from"./TUPG9Pl9.js";import"./Fejg-vgw.js";import{d as x,x as c,y as f,B as l,C as a,D as A,z as _,A as P,E as S,g as r,_ as $}from"./Bd8Sv95l.js";import"./DXASGQAI.js";const N={class:"test-page"},C={key:0,class:"result"},O=x({__name:"test",setup(w){const o=r("test_app_token"),n=r("test_table_id"),p=r(!1),t=r("");async function v(){p.value=!0,t.value="";try{if(!o.value||!n.value){t.value="请输入 App Token 和 Table ID";return}const s=await $fetch("/api/test");t.value=`基本API测试:
