...
import { E as ElCard, a as ElInput } from './el-input-C0wHdJAW.mjs';
import { a as ElSelect, b as ElOption, c as ElRadioGroup, d as ElRadio, e as ElTag, E as ElAlert } from './el-radio-group-Bt7L-KaK.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "url-expander-plugin" }, _attrs))} data-v-6d8cca0c>`);
      _push(ssrRenderComponent(_component_ScriptHeader, {
        title: "\u{1F517} \u77ED\u94FE\u63A5\u6279\u91CF\u6269\u5C55\u5DE5\u5177",
        description: "\u81EA\u52A8\u83B7\u53D6\u5F53\u524D\u8868\u683C\u4FE1\u606F\uFF0C\u6279\u91CF\u5C06\u77ED\u94FE\u63A5\u8F6C\u6362\u4E3A\u5B9E\u9645\u94FE\u63A5"
      }, null, _parent));
      if (isReady.value && unref(currentTable)) {
        _push(`<div class="main-content" data-v-6d8cca0c>`);
        _push(ssrRenderComponent(_component_el_card, { class: "operation-card" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-content" data-v-6d8cca0c${_scopeId}><div class="compact-form" data-v-6d8cca0c${_scopeId}><div class="form-group" data-v-6d8cca0c${_scopeId}>`);
              ...
              _push2(`<div class="help-text" data-v-6d8cca0c${_scopeId}> \u{1F4A1} \u591A\u4E2A\u57DF\u540D\u7528\u9017\u53F7\u5206\u9694\uFF0C\u7559\u7A7A\u5339\u914D\u6240\u6709URL </div></div><div class="form-group" data-v-6d8cca0c${_scopeId}>`);
              ...
              if (textFields.value.length === 0) {
                _push2(`<div class="help-text" data-v-6d8cca0c${_scopeId}> \u26A0\uFE0F \u672A\u627E\u5230\u6587\u672C\u7C7B\u578B\u7684\u5217 </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="form-group" data-v-6d8cca0c${_scopeId}>`);
              ...
              if (replaceMode.value === "newColumn") {
                _push2(`<div class="form-group" data-v-6d8cca0c${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_input, {
        ...
        if (selectedFieldId.value && matchingUrls.value.length > 0) {
          _push(`<div class="preview-section" data-v-6d8cca0c>`);
          _push(ssrRenderComponent(_component_el_card, null, {
            header: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="preview-header" data-v-6d8cca0c${_scopeId}><h3 data-v-6d8cca0c${_scopeId}>\u{1F4CA} \u6570\u636E\u9884\u89C8</h3><div class="preview-stats" data-v-6d8cca0c${_scopeId}> \u627E\u5230 ${ssrInterpolate(matchingUrls.value.length)} \u4E2A\u5339\u914D\u7684\u77ED\u94FE\u63A5 </div></div>`);
              } else {
                return [
        ...
        _push(`<div class="action-section" data-v-6d8cca0c>`);
        _push(ssrRenderComponent(_component_el_card, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="action-buttons" data-v-6d8cca0c${_scopeId}>`);
              ...
              if (processing.value || processCompleted.value) {
                _push2(`<div class="progress-section" data-v-6d8cca0c${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_progress, {
                  percentage: progressPercentage.value,
                  status: progressStatus.value,
                  "stroke-width": 8
                }, null, _parent2, _scopeId));
                _push2(`<p class="progress-info" data-v-6d8cca0c${_scopeId}> \u5DF2\u5904\u7406 ${ssrInterpolate(processedCount.value)} / ${ssrInterpolate(totalCount.value)} \u6761\u8BB0\u5F55 `);
                if (processCompleted.value) {
                  _push2(`<span data-v-6d8cca0c${_scopeId}> \uFF08\u6210\u529F ${ssrInterpolate(successCount.value)} \u6761\uFF0C\u5931\u8D25 ${ssrInterpolate(failedCount.value)} \u6761\uFF09 </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</p></div>`);
...
const urlExpanderPlugin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d8cca0c"]]);

export { urlExpanderPlugin as default };
//# sourceMappingURL=url-expander-plugin-7wYAxTwc.mjs.map
