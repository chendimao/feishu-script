import { E as ElAlert, a as ElSelect, b as ElOption, c as ElRadioGroup, d as ElRadio } from './el-radio-group-rSbCBU2-.mjs';
...
import { E as ElCollapse, a as ElCollapseItem } from './el-collapse-item-JsMPhz3g.mjs';
      ...
      if (feishuConfig.appToken && feishuConfig.tableId) {
        ...
        _push(ssrRenderComponent(_component_el_card, { class: "operation-card" }, {
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-header" data-v-18da5ae0${_scopeId}><div class="card-icon" data-v-18da5ae0${_scopeId}>\u{1F3AF}</div><h3 data-v-18da5ae0${_scopeId}>\u77ED\u94FE\u63A5\u5339\u914D\u89C4\u5219</h3></div>`);
            } else {
              return [
                    ...
                    _push3(ssrRenderComponent(_component_el_form_item, { label: "\u5339\u914D\u89C4\u5219" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="help-text" data-v-18da5ae0${_scopeId3}> \u{1F4A1} \u652F\u6301\u591A\u4E2A\u57DF\u540D\uFF0C\u7528\u9017\u53F7\u5206\u9694\u3002\u7559\u7A7A\u5219\u5339\u914D\u6240\u6709URL </div>`);
                        } else {
                          return [
        ...
        _push(ssrRenderComponent(_component_el_card, { class: "operation-card" }, {
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-header" data-v-18da5ae0${_scopeId}><div class="card-icon" data-v-18da5ae0${_scopeId}>\u{1F4CB}</div><h3 data-v-18da5ae0${_scopeId}>\u9009\u62E9\u64CD\u4F5C\u5217</h3></div>`);
            } else {
              return [
                createVNode("div", { class: "card-header" }, [
...
//# sourceMappingURL=url-expander-simple-DGovd6x6.mjs.map
