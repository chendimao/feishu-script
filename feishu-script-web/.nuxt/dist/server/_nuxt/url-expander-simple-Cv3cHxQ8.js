import { E as ElAlert, a as ElSelect, b as ElOption, c as ElRadioGroup, d as ElRadio } from "./el-radio-group-D81v3l6w.js";
...
import { E as ElCollapse, a as ElCollapseItem } from "./el-collapse-item-BD9RZOSV.js";
      ...
      if (feishuConfig.appToken && feishuConfig.tableId) {
        ...
        _push(ssrRenderComponent(_component_el_card, { class: "operation-card" }, {
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-header" data-v-f4c54c93${_scopeId}><div class="card-icon" data-v-f4c54c93${_scopeId}>🎯</div><h3 data-v-f4c54c93${_scopeId}>短链接匹配规则</h3></div>`);
            } else {
              return [
                    ...
                    _push3(ssrRenderComponent(_component_el_form_item, { label: "匹配规则" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="help-text" data-v-f4c54c93${_scopeId3}> 💡 支持多个域名，用逗号分隔。留空则匹配所有URL </div>`);
                        } else {
                          return [
        ...
        _push(ssrRenderComponent(_component_el_card, { class: "operation-card" }, {
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="card-header" data-v-f4c54c93${_scopeId}><div class="card-icon" data-v-f4c54c93${_scopeId}>📋</div><h3 data-v-f4c54c93${_scopeId}>选择操作列</h3></div>`);
            } else {
              return [
                createVNode("div", { class: "card-header" }, [
                  createVNode("div", { class: "card-icon" }, "📋"),
...
//# sourceMappingURL=url-expander-simple-Cv3cHxQ8.js.map
