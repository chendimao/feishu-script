declare global {
  ...
  const clearTokenCache: typeof import('../../server/utils/feishu-auth').clearTokenCache
  const createApp: typeof import('../../node_modules/h3').createApp
  const createAppEventHandler: typeof import('../../node_modules/h3').createAppEventHandler
  const createError: typeof import('../../node_modules/h3').createError
  const createEvent: typeof import('../../node_modules/h3').createEvent
  const createEventStream: typeof import('../../node_modules/h3').createEventStream
  const createFeishuHeaders: typeof import('../../server/utils/feishu-auth').createFeishuHeaders
  const createRouter: typeof import('../../node_modules/h3').createRouter
  const createTableField: typeof import('../../server/utils/feishu-bitable').createTableField
  ...
  const expandUrl: typeof import('../../server/utils/url-expander').expandUrl
  const expandUrlsInBatch: typeof import('../../server/utils/url-expander').expandUrlsInBatch
  const extractUrls: typeof import('../../server/utils/url-expander').extractUrls
  ...
  const getTableFields: typeof import('../../server/utils/feishu-bitable').getTableFields
  const getTableRecords: typeof import('../../server/utils/feishu-bitable').getTableRecords
  const getTenantAccessToken: typeof import('../../server/utils/feishu-auth').getTenantAccessToken
  ...
  const processCellContent: typeof import('../../server/utils/url-expander').processCellContent
  ...
  const updateTableRecords: typeof import('../../server/utils/feishu-bitable').updateTableRecords
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'E:/phpStudy/WWW/feishuScript/feishu-script-web/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'E:/phpStudy/WWW/feishuScript/feishu-script-web/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getTenantAccessToken, clearTokenCache, createFeishuHeaders } from 'E:/phpStudy/WWW/feishuScript/feishu-script-web/server/utils/feishu-auth';
export { getTableFields, getTableRecords, updateTableRecords, createTableField } from 'E:/phpStudy/WWW/feishuScript/feishu-script-web/server/utils/feishu-bitable';
export { expandUrl, expandUrlsInBatch, extractUrls, processCellContent } from 'E:/phpStudy/WWW/feishuScript/feishu-script-web/server/utils/url-expander';